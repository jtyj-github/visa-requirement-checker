This is a webapp that displays the type of visa a traveler would have to apply for when traveling to a particular country. I created the starting files using nextjs bootstrap create-next-app.
